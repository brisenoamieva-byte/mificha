    ...
    >
      ...
      <LegalSection title="4. Fichas públicas y directorio">
        <LegalParagraph>
          ...
          /fut/explorar requiere consentimiento registrado en la plataforma. MiFicha puede
      ...
      <LegalSection title="6. Planes, pagos y cancelación">
        ...
        <LegalParagraph>
          ...
          <Link href="/fut/organizadores" className="text-mf-brand hover:underline">
            mificha.mx/fut/organizadores
          </Link>
