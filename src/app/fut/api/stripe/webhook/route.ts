  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:24px;">
        ...
        <p><a href="${appUrl}/fut/dashboard" style="display:inline-block;background:#1B4F8C;color:#fff;padding:12px 18px;border-radius:10px;text-decoration:none;font-weight:700;">Ir al dashboard</a></p>
      </div>
    `,
    text: `No pudimos procesar el último pago de ${academyName}. Actualiza tu método de pago en ${appUrl}/fut/dashboard`,
  });
}
