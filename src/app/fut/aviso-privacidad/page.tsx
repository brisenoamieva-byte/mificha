  ...
  return (
    ...
    >
      ...
      <LegalSection title="Dos niveles de visibilidad">
        ...
        <LegalParagraph>
          <strong className="text-mf-text">Directorio y rankings (/fut/explorar):</strong>{" "}
      ...
      <section className="mt-10 rounded-xl border border-mf-border bg-mf-surface p-5">
        ...
        <Link href="/fut/signup" className="mf-btn-secondary mt-4 inline-flex">
          Registrar academia
        </Link>
        <Link href="/fut/login" className="mf-btn-ghost mt-3 inline-flex">
          Ya tengo cuenta
        </Link>
      </section>
    </LegalPageShell>
