...
const steps = [
  ...
  {
    icon: ShieldCheck,
    title: "Consulta la ficha",
    description: "Stats del torneo, evaluación del entrenador e historial de temporada.",
  },
];
...
export function ParentLinkForm() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <label htmlFor="player-link" className="block text-lg font-semibold text-mf-text">
