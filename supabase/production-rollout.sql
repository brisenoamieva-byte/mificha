...
-- ===== official-match-scoring-rls.sql =====
-- MiFicha â€” Marcador oficial solo organizador (jornadas is_official)
-- Ejecutar en Supabase â†’ SQL Editor (paso 20, despuÃ©s de #15 platform-fixtures-rls)
--
...
comment on column public.matches.result_locked_at is
  'Momento en que el organizador fijÃ³ el marcador oficial de la jornada.';
...
-- ===== official-match-stats-rls.sql =====
-- MiFicha â€” Acta oficial: stats individuales solo organizador en jornadas is_official
-- Ejecutar en Supabase â†’ SQL Editor (paso 21, despuÃ©s de #20)
--
...
comment on column public.matches.acta_published_at is
  'Cuando el organizador publicÃ³ goles/asistencias/tarjetas del acta oficial.';
